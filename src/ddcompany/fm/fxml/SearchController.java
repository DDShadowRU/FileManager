...
public class SearchController {
    ...
    @FXML private CheckBox checkBoxIsRegEx;
    @FXML private CheckBox checkBoxContains;
    @FXML private CheckBox checkBoxSearchFiles;
    @FXML private CheckBox checkBoxSearchFolders;
    @FXML private CheckBox checkBoxSubDirs;
    @FXML private Button buttonOpen;
    @FXML private Button buttonTo;
    ...
    /**
     * Показать файл
     * @param selectedFile файл, который необходимо показать
     * @param f в какой панели необходимо показать
     */
    ...
    /*  EVENTS  */
    @FXML private void onBtnPasteLeftPathClick(){
        fieldPath.setText(Main.getStageController().getTableViewLeftPath());
    }
    @FXML private void onBtnPasteRightPathClick(){
        fieldPath.setText(Main.getStageController().getTableViewRightPath());
    }
    @FXML private void onBtnToClick(){
        if ( listView.getSelectionModel().getSelectedIndex() != -1 ) {
            File selectedFile = files.get(listView.getSelectionModel().getSelectedIndex());
            String f = "";
    ...
    @FXML private void onBtnOpenClick(){
    ...
    @FXML private void onBtnSearchClick(){
        ...
        if ( filePath.isDirectory() && filePath.exists() ) {
            ...
            files.addAll(Util.getFilesMatchedRegex(new ArrayList<File>(), filesList, regex, checkBoxSubDirs.isSelected(), checkBoxSearchFolders.isSelected(), checkBoxSearchFiles.isSelected()));
